...
<!-- !PAGE CONTENT! -->
  ...
  <img src="images/home pic1.jpg" alt="Lights" style="width:100%">
  ...
  <div class="w3-display-topmiddle" style="font-size: 30px"><p>PROJECT: PAYROLL SYSTEM.<p>
                                                            <p>  SUBJECT: DBMS.<p>
                                                            <p>  MEMBERS: VICTOR THOMAS<p>
                                                                     <p>  SHASHANK SHUKLA<p>
                                                                     <p>  ALEX RAPPAI<p>
                                                            <p>  PROFESSOR: LALITA MOHARKAR </p></div>
...
<div class="w3-dark-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right">Devs:VICTOR&ALEX</p></div>
